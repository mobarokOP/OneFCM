  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        aria-expanded={open}
        className={cn(
          'flex w-full min-w-[180px] items-center justify-between gap-2 rounded-xl border border-input bg-card px-3 py-2 text-sm transition-[background-color,border-color,box-shadow] duration-150 hover:border-muted-foreground/30 hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring active:scale-[0.99]',
      ...
      {open && (
        <div className="absolute left-0 top-full z-40 mt-1.5 w-64 origin-top-left animate-dropdown-in rounded-xl border border-border bg-card p-1.5 shadow-overlay">
